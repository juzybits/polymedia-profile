...
export const Docs: React.FC = () =>
{
    ...
    return <div id="page" className="page-about">
        ...
        <ol>
            ...
            <li>The default registry is called <i><a href={makePolymediaUrl(network, "object", profileManager.registryId)} target="_blank" rel="noopener noreferrer">polymedia-main</a></i>, and is used by all Polymedia apps. <b>Anyone</b> can create a new registry.</li>
