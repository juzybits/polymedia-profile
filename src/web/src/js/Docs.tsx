...
export const Docs: React.FC = () =>
{
    ...
    return <div id='page' className='page-about'>
        ...
        <p>
            The code and technical docs can be found on the <a href='https://github.com/juzybits/polymedia-profile/' target='_blank' rel='noopener'>GitHub repo</a>:
        </p>
        <ul>
            <li><a href='https://github.com/juzybits/polymedia-profile/tree/main/sui' target='_blank' rel='noopener'>Sui Move package</a>: the on-chain profile system.</li>

            <li><a href='https://github.com/juzybits/polymedia-profile/tree/main/sdk' target='_blank' rel='noopener'>TypeScript SDK</a>: a library that can be <a href='https://www.npmjs.com/package/@polymedia/profile-sdk' target='_blank' rel='noopener'>npm installed</a>.</li>

            <li><a href='https://github.com/juzybits/polymedia-profile/tree/main/web' target='_blank' rel='noopener'>Web interface</a>: the website you're on right now.</li>
        </ul>
